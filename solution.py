...
class SWAGInference(object):
    ...
    def update_swag(self,i) -> None:
        ...
        self.swag_update_step += 1/self.bma_samples
        # SWAG-diagonal
        ...
        if self.inference_mode == InferenceMode.SWAG_FULL:
            ...
            for name, param in current_params.items():
                ...
                self.D_column[name] = param - self.theta_swa_running[name]#/(self.swag_update_step+1)#self.theta_swa_running[name]
                #for name, param in current_params.items():
    ...
    def sample_parameters(self) -> None:
        ...
        for name, param in self.network.named_parameters():
            ...
            if self.inference_mode == InferenceMode.SWAG_FULL:
                ...
                sampled_param += (D_matrix @ z_2) / np.sqrt((self.deviation_matrix_max_rank-1))
